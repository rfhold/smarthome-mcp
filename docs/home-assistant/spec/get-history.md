...
`history.get` accepts 1 through 10 unique entity IDs, a required RFC3339 `start`, and an optional RFC3339 `end` that defaults to the current time. The interval must be positive and no longer than 24 hours.
