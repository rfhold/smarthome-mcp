...
These documents describe deployment declarations, pipeline behavior, and operator validation. They do not claim that an uncommitted revision has reached preview.
