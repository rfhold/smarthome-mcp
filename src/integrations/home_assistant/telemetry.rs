...
fn metric_action(value: &'static str) -> &'static str {
    match value {
        ...
        "blueprint.get" => "blueprint.get",
        "blueprint.save" => "blueprint.save",
        "automation.from_blueprint" => "automation.from_blueprint",
        "smarthome_mcp.setup" => "smarthome_mcp.setup",
        "home_assistant.restart" => "home_assistant.restart",
...
pub(super) fn request_outcome<T>(result: &Result<T, Error>) -> &'static str {
    match result {
        ...
        Err(Error::NotFound | Error::ConfigNotFound) => "not_found",
